...
class SimpleCaptcha {
  ...
  private $images = array(
    // NAME          =>  IMAGE_FILE
      'house'        => 'img/captchaImages/01.png',
      'key'          => 'img/captchaImages/02.png',
      'flag'         => 'img/captchaImages/03.png',
      'clock'        => 'img/captchaImages/04.png',
      'bug'          => 'img/captchaImages/05.png',
      'pen'          => 'img/captchaImages/06.png',
      'light bulb'   => 'img/captchaImages/07.png',
      'musical note' => 'img/captchaImages/08.png',
      'heart'        => 'img/captchaImages/09.png',
      'world'        => 'img/captchaImages/10.png'
  );

  // You should change this for security reasons, 10-20 characters is good
  private $salt = "#^g_@j%^G*8!w_^y";
